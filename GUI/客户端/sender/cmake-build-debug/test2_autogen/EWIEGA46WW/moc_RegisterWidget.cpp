...
QT_MOC_LITERAL(1, 15, 17), // "returnLoginSignal"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "RegisterWidget\0returnLoginSignal\0"
};
...
void RegisterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->returnLoginSignal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterWidget::returnLoginSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWidget::returnLoginSignal()
{
