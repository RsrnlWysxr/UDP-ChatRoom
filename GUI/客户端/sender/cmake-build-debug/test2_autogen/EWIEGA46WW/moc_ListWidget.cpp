...
QT_MOC_LITERAL(1, 11, 17), // "returnLoginSignal"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "ListWidget\0returnLoginSignal\0"
};
...
void ListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ListWidget::returnLoginSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ListWidget::returnLoginSignal()
{
